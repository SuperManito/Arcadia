...
export const AuroraText = memo(({ children, className = '', colors = ['#7928CA', '#0070F3', '#38bdf8'], speed = 1 }: AuroraTextProps) => {
  const gradientStyle = {
...
export default function Hero () {
  ...
  return (
        <header className={clsx('container', styles.heroBanner, 'min-[1920px]:pt-0 min-[1920px]:pb-0')}>
            <div className="row padding-horiz--md">{!isMobile ? <HeroContentDefault /> : <HeroContentMobile />}</div>
        </header>
  )
}
