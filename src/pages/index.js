    ...
    <header className={clsx('container', styles.heroBanner)}>
      ...
      <div className="row padding-horiz--md">
        <div className="col col--7">
          ...
          <div>
            <Link className="button button--block button--primary button--outline button--lg" to="/docs">
              开 始 使 用
            </Link>
          </div>
        </div>
      ...
      <div className="row">
        <div className="col col--6">
          ...
          <div className="avatar" style={{ padding: '1em 0' }}>
            ...
            <div className="avatar__intro">
              <div className="avatar__name">Vue 3</div>
            </div>
          </div>
          <div className="avatar" style={{ padding: '.5em 0' }}>
