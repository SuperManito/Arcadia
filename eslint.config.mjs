...
export default antfu({
  ...
  rules: {
    ...
    'unicorn/prefer-number-properties': 'off', // 关闭优先使用 Number 属性的规则
    'node/prefer-global/process': 'off', // 关闭优先使用全局 process 的规则
    'node/prefer-global/buffer': 'off', // 关闭优先使用全局 buffer 的规则
